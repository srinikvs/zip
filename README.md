...
1. Version ID (`v1.0.3`) on the how-to-play screen, the play HUD, and the win card.
...
Pool: 10 Easy (5×5, light walls), 10 Medium (6×6, mixed walls), 10 Hard (6×6 / 7×7, corridor walls that block S-curve snakes). Next board is random from unused ids.
